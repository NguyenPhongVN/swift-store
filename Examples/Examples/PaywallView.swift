...
//                        .animation(.easeInOut(duration: 2.5).repeatForever(autoreverses: true), value: isAnimating)
                ...
                VStack(spacing: 16) {
                    Text("✨ Unlock Premium")
                        ...
                        .scaleEffect(textAnimation ? 1.0 : 0.8)
                        .opacity(textAnimation ? 1.0 : 0.0)
                        .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(0.3), value: textAnimation)
                    ...
                    VStack(spacing: 12) {
                        Text("Transform Your Experience")
                            ...
                            .scaleEffect(textAnimation ? 1.0 : 0.8)
                            .opacity(textAnimation ? 1.0 : 0.0)
                            .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(0.5), value: textAnimation)
                        ...
                        Text("Join thousands of users who've upgraded to premium and achieved their goals faster")
                            ...
                            .scaleEffect(textAnimation ? 1.0 : 0.8)
                            .opacity(textAnimation ? 1.0 : 0.0)
                            .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(0.7), value: textAnimation)
                    }
                }
            }
            ...
            VStack(spacing: 24) {
                VStack(spacing: 8) {
                    Text("🌟 Premium Features")
                        ...
                        .scaleEffect(textAnimation ? 1.0 : 0.8)
                        .opacity(textAnimation ? 1.0 : 0.0)
                        .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(0.9), value: textAnimation)
                    ...
                    Text("Everything you need to succeed")
                        ...
                        .scaleEffect(textAnimation ? 1.0 : 0.8)
                        .opacity(textAnimation ? 1.0 : 0.0)
                        .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(1.1), value: textAnimation)
                }
            ...
            VStack(spacing: 20) {
                VStack(spacing: 12) {
                    Text("🎯 Limited Time Offer")
                        ...
                        .scaleEffect(textAnimation ? 1.0 : 0.8)
                        .opacity(textAnimation ? 1.0 : 0.0)
                        .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(2.1), value: textAnimation)
                    ...
                    Text("Save 70% today only!")
                        ...
                        .scaleEffect(textAnimation ? 1.0 : 0.8)
                        .opacity(textAnimation ? 1.0 : 0.0)
                        .animation(.spring(response: 0.8, dampingFraction: 0.6).delay(2.3), value: textAnimation)
                }
